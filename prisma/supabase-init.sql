...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('INVITATION', 'ASSIGNMENT', 'COMMENT', 'DUE_DATE', 'SYSTEM');
...
-- CreateIndex
CREATE UNIQUE INDEX "Column_boardId_status_key" ON "Column"("boardId", "status");
